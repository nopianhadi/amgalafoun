        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Deskripsi singkat tentang perusahaan atau layanan yang Anda tawarkan.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/guide" className="text-gray-300 hover:text-white transition-colors">Guide</a></li>
